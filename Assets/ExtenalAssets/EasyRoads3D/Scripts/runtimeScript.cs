...
//		Debug.Log(roadType.roadMaterial);
    ...
    //  road.InsertMarkerAt(Vector3 pos, int index): void;
		...
		markers1[0] = new Vector3(500, 5, 200);
		markers1[1] = new Vector3(300, 5, 250);

		road1 = roadNetwork.CreateRoad("road 2", roadType, markers1);
		roadNetwork.ConnectRoads(road1, road);
