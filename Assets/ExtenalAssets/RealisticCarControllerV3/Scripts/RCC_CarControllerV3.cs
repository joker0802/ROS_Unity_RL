...
public class RCC_CarControllerV3 : MonoBehaviour
{
    ...
    private int drivingMode;                // 0: automatic mode, 1: semi-automatic mode, 2: manual mode
    ...
    public int direction = -1;       // Forward Gear Currently.
    ...
    void Awake()
    {
        automaticGear = RCCSettings.useAutomaticGear;
        drivingMode = 0;
    ...
    void Update()
    {
        ...
        if (canControl)
        {
            if (!AIController)
            {
                if (Input.GetKeyDown("m") || Input.GetKeyDown("joystick 1 button 6"))
                {
                    if (drivingMode == 0)
                    {
                        automaticGear = false;
    ...
    void Inputs()
    {
        ...
        switch (RCCSettings.controllerType)
        {
            ...
            case RCC_Settings.ControllerType.Keyboard:
                ...
                gasInput = Mathf.Max(Input.GetAxis(RCCSettings.verticalInput), (Input.GetAxis("Throttle") + 1f) / 2);
                brakeInput = Mathf.Max(Mathf.Clamp01(-Input.GetAxis(RCCSettings.verticalInput)), (Input.GetAxis("Break") + 1f) / 2);
                //Debug.Log("Break,, "+Input.GetAxis("Break"));
                ...
                if (Input.GetKeyDown(RCCSettings.lowBeamHeadlightsKB) || Input.GetKeyDown("joystick 1 button 3"))
                {
                    lowBeamHeadLightsOn = !lowBeamHeadLightsOn;
                }

                if (Input.GetKeyDown(RCCSettings.highBeamHeadlightsKB) || Input.GetKeyDown("joystick 1 button 0"))
                {
                    highBeamHeadLightsOn = true;
                }
                else if (Input.GetKeyUp(RCCSettings.highBeamHeadlightsKB) || Input.GetKeyDown("joystick 1 button 0"))
                {
                    highBeamHeadLightsOn = false;
                }

                if (Input.GetKeyDown(RCCSettings.startEngineKB) || Input.GetKeyDown("joystick 1 button 9"))
                    KillOrStartEngine();

                if (Input.GetKeyDown(RCCSettings.rightIndicatorKB) || Input.GetKeyDown("joystick 1 button 11"))
                {
                ...
                if (Input.GetKeyDown(RCCSettings.leftIndicatorKB) || Input.GetKeyDown("joystick 1 button 7"))
                {
                ...
                if (!automaticGear)
                {
                    if (drivingMode == 2)
                    {
                        if (Input.GetKeyDown("1") || Input.GetKeyDown("joystick 1 button 13"))
                        {
                            if (direction != -1)
                        ...
                        else if (Input.GetKeyDown("2") || Input.GetKeyDown("joystick 1 button 14"))
                        {
                            if (direction != -1)
                        ...
                        else if (Input.GetKeyDown("3") || Input.GetKeyDown("joystick 1 button 15"))
                        {
                            if (direction != -1)
                        ...
                        else if (Input.GetKeyDown("4") || Input.GetKeyDown("joystick 1 button 16"))
                        {
                            if (direction != -1)
                        ...
                        else if (Input.GetKeyDown("5") || Input.GetKeyDown("joystick 1 button 17"))
                        {
                            if (direction != -1)
                        ...
                        else if (Input.GetKeyDown("6") || Input.GetKeyDown("joystick 1 button 18"))
                        {
                            if (direction != -1)
                                StartCoroutine("ChangingGear", 5);
                            else
                                StartCoroutine("ChangingGear", 0);
                        }
                        else if (Input.GetKeyDown("7") || Input.GetKeyDown("joystick 1 button 19"))
                        {
                            if (direction != -1)
                                StartCoroutine("ChangingGear", 6);
                            else
                                StartCoroutine("ChangingGear", 0);
                        }
                        else if (Input.GetKeyDown("r") || Input.GetKeyDown("joystick 1 button 12"))
                        {
                            if (direction != -1)
                                StartCoroutine("ChangingGear", -1);
                            else
                    ...
                    else if (drivingMode == 1)
                    {
                        ...
                        {
                            if (Input.GetKeyDown(RCCSettings.shiftGearUp) || Input.GetKeyDown("joystick 1 button 4"))
                            {
                                if (direction != -1)
                        ...
                        if (currentGear >= 0)
                        {
                            if (Input.GetKeyDown(RCCSettings.shiftGearDown) || Input.GetKeyDown("joystick 1 button 5"))
                            {
                                StartCoroutine("ChangingGear", currentGear - 1);
                            }
                        }
