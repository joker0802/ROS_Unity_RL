	...
	namespace sensor_msgs {
		...
		public class JointStateMsg: ROSBridgeMsg {
			...
			public override string ToYAMLString() {
                ...
                {
                    pos_array = pos_array + _position[i];
                    if (_position.Length - i > 1)
                        pos_array += ",";
                }
                pos_array += "]";
                ...
                {
                    vel_array = vel_array + _velocity[i];
                    if (_velocity.Length - i > 1)
                        vel_array += ",";
                }
                vel_array += "]";
                ...
                {
                    effort_array = effort_array + _effort[i];
                    if (_effort.Length - i > 1)
                        effort_array += ",";
                }
                effort_array += "]";
